...
$(document).ready(function () {
    ...
    ischool.chooseWish.cnCommon = gadget.getContract("ischool.preRecommendedAdmission.c2");
    var cnCommon = ischool.chooseWish.cnCommon;

    //如果登入 contract 成功
    cnCommon.ready(function () {
        //1. 連結 contract : ischool.推甄系統.學生
        ischool.chooseWish.cnStud = gadget.getContract("ischool.preRecommendedAdmission.c2.Student");
